...
##############################################################################
# Umaten トップページプラグイン v2.10.4 本番環境デプロイスクリプト
#
# 実行方法:
#   curl -o /tmp/deploy-v2.10.4.sh https://raw.githubusercontent.com/inosuke680-sys/toppage-2.8.3-/claude/remove-popular-genre-update-layout-01Q3CQHiR3WZZMyJCDjpyMhq/deploy-production-v2.10.4.sh
#   chmod +x /tmp/deploy-v2.10.4.sh
#   sudo /tmp/deploy-v2.10.4.sh
##############################################################################
...
PLUGIN_NAME="umaten-toppage-v2.10.4"
...
echo ""
echo "=========================================="
echo "  Umaten プラグイン v2.10.4 デプロイ"
echo "=========================================="
echo ""
...
# 4. 新しいプラグインのダウンロード
log_info "新しいプラグイン v2.10.4 をダウンロード中..."
mkdir -p "$TEMP_DIR"
cd "$TEMP_DIR"
...
# 7. 新しいプラグインのインストール
log_info "新しいプラグイン v2.10.4 をインストール中..."
...
echo ""
log_success "v2.10.4 の変更内容:"
echo "  /hokkaido/hakodate/ramen/ へのリンクを検索ウィジェットURLに自動書き換え"
echo "  "
echo "  【修正内容】"
echo "    HTMLの出力バッファを使用してリンクを書き換え (umaten-toppage.php: 114-158行)："
echo "    "
echo "    1. wp_loaded フックで出力バッファ開始"
echo "    2. すべてのHTML出力をキャプチャ"
echo "    3. 正規表現で /hokkaido/hakodate/ramen/ へのリンクを検索"
echo "    4. 検索ウィジェットURL（/?umaten_category=10&umaten_tag=426&umaten_search=1）に置換"
echo "    5. 書き換えたHTMLを出力"
echo "  "
echo "  【動作】"
echo "    1. ページが表示される際、出力バッファがHTML全体をキャプチャ"
echo "    2. href=\"https://umaten.jp/hokkaido/hakodate/ramen/\" を検索"
echo "    3. href=\"https://umaten.jp/?umaten_category=10&umaten_tag=426&umaten_search=1\" に置換"
echo "    4. ユーザーに書き換えられたHTMLを表示"
echo "    5. リンクをクリックすると検索ウィジェットの結果ページに移動"
echo "  "
echo "  【利点】"
echo "    - どこで生成されたリンクでも自動的に書き換え"
echo "    - ナビゲーション、メニュー、ウィジェットすべてに対応"
echo "    - テンプレートファイルの変更不要"
echo "    - v2.10.3のリダイレクト機能も継続"
echo "  "
echo "  【その他の修正（継続）】"
echo "    - v2.10.3: /hokkaido/hakodate/ramen/ へのアクセスを検索ウィジェットURLにリダイレクト"
