...
##############################################################################
# デバッグプラグイン インストールスクリプト
#
# 用途：template_include フィルターチェーンと WP_Query の状態を追跡
# 実行方法：
#   curl -o /tmp/debug-template-loader.php https://raw.githubusercontent.com/inosuke680-sys/toppage-2.8.3-/claude/remove-popular-genre-update-layout-01Q3CQHiR3WZZMyJCDjpyMhq/debug-template-loader.php
#   curl -o /tmp/install-debug.sh https://raw.githubusercontent.com/inosuke680-sys/toppage-2.8.3-/claude/remove-popular-genre-update-layout-01Q3CQHiR3WZZMyJCDjpyMhq/install-debug-plugin.sh
#   chmod +x /tmp/install-debug.sh
#   sudo /tmp/install-debug.sh
##############################################################################
...
DEBUG_PLUGIN_SOURCE="/tmp/debug-template-loader.php"
DEBUG_PLUGIN_DEST="${MU_PLUGINS_DIR}/debug-template-loader.php"
LOG_FILE="/tmp/template-debug.log"

echo ""
echo "=========================================="
echo "  デバッグプラグイン インストール"
echo "=========================================="
echo ""
