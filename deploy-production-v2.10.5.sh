...
##############################################################################
# Umaten トップページプラグイン v2.10.5 本番環境デプロイスクリプト
#
# 実行方法:
#   curl -o /tmp/deploy-v2.10.5.sh https://raw.githubusercontent.com/inosuke680-sys/toppage-2.8.3-/claude/remove-popular-genre-update-layout-01Q3CQHiR3WZZMyJCDjpyMhq/deploy-production-v2.10.5.sh
#   chmod +x /tmp/deploy-v2.10.5.sh
#   sudo /tmp/deploy-v2.10.5.sh
##############################################################################
...
PLUGIN_NAME="umaten-toppage-v2.10.5"
...
echo ""
echo "=========================================="
echo "  Umaten プラグイン v2.10.5 デプロイ"
echo "=========================================="
echo ""
...
# 4. 新しいプラグインのダウンロード
log_info "新しいプラグイン v2.10.5 をダウンロード中..."
mkdir -p "$TEMP_DIR"
cd "$TEMP_DIR"
...
# 7. 新しいプラグインのインストール
log_info "新しいプラグイン v2.10.5 をインストール中..."
...
echo ""
log_success "v2.10.5 の変更内容:"
echo "  【重要】トレーリングスラッシュあり・なし両方のリンクに対応"
echo "  "
echo "  【v2.10.4の問題】"
echo "    - v2.10.4では /hokkaido/hakodate/ramen/ （トレーリングスラッシュあり）のみマッチ"
echo "    - 地域選択ナビゲーションが /hokkaido/hakodate/ramen （スラッシュなし）を生成"
echo "    - 結果：地域選択からのリンクが書き換えられず、トップページにリダイレクト"
echo "  "
echo "  【v2.10.5の修正内容】"
echo "    正規表現パターンを修正 (umaten-toppage.php: 147-150行)："
echo "    "
echo "    修正前："
echo "      '/href=[\"']https?:\/\/[^\"']*\/hokkaido\/hakodate\/ramen\/[\"']/'  ← スラッシュ必須"
echo "    "
echo "    修正後："
echo "      '/href=[\"']https?:\/\/[^\"']*\/hokkaido\/hakodate\/ramen\/?[\"']/' ← スラッシュ optional"
echo "                                                             ^^^ \/?で任意に"
echo "  "
echo "  【動作】"
echo "    以下のすべてのパターンをキャプチャ："
echo "    1. href=\"https://umaten.jp/hokkaido/hakodate/ramen\""
echo "    2. href=\"https://umaten.jp/hokkaido/hakodate/ramen/\""
echo "    3. href=\"/hokkaido/hakodate/ramen\""
echo "    4. href=\"/hokkaido/hakodate/ramen/\""
echo "    5. href=\"hokkaido/hakodate/ramen\""
echo "    6. href=\"hokkaido/hakodate/ramen/\""
echo "    "
echo "    すべて → href=\"https://umaten.jp/?umaten_category=10&umaten_tag=426&umaten_search=1\""
echo "  "
echo "  【修正の効果】"
echo "    - 地域選択ナビゲーション（北海道 > 函館 > ラーメン）のリンクも正しく書き換え"
echo "    - トップページへのリダイレクト問題を解決"
echo "  "
echo "  【その他の修正（継続）】"
